...
export default function AdminLayout({children}){
  ...
  <Link href='/admin'> <li className='text-lg font-medium md:mt-6  mt-4  bg-black text-gray-400 hover:text-white hover:bg-gray-900 p-2  rounded' ><div className="flex gap-1"><FiLogOut className='text-2xl text-center' />LogOut</div></li></Link>
  <Link href='/admin/alleve/analytics'><li className='text-lg font-medium md:mt-6  mt-4  bg-black text-gray-400 hover:text-white hover:bg-gray-900 p-2  rounded' ><div className="flex gap-1"><GrAnalytics className='text-2xl text-center'/>Analytics</div></li></Link>
  </ol>
  
  <h1 className='text-lg font-bold mt-40 text-white text-center'><CgProfile className="text-5xl text-center ml-20 mb-2 text-white" />Admin</h1>
