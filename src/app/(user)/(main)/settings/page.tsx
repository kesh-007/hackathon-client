  ...
  return (
    <div className='w-full h-screen flex flex-col overflow-y-scroll mb-8'>
        ...
        <div className='flex bg-white rounded-3xl mt-5 mx-5'>
          <input type="text" className=" rounded-3xl w-full border-[4px] border-white pl-3 py-2" placeholder='Search'></input>
        ...
        <div className='flex flex-col justify-center my-7 mx-4 '>
          ...
          <p className='text-md flex flex-1 justify-center mr-7 text-[#f64d41]'>Logout</p>
